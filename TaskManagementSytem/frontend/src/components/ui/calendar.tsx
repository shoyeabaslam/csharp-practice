    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-full aria-selected:bg-yellow-300 aria-selected:border aria-selected:border-slate-400 aria-selected:text-slate-900 "
        ),
        day_range_end: "day-range-end ",
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground ",
        day_today: "bg-yellow-100 text-accent-foreground ",
        day_outside:
